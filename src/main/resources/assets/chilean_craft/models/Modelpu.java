...
public static class Modelpu extends ModelBase {
	...
	public Modelpu() {
		...
		Body.cubeList.add(new ModelBox(Body, 14, 8, -2.0F, 36.0F, -9.0F, 8, 7,
				17, 0.0F, false));
		Body.cubeList.add(new ModelBox(Body, 9, 15, -2.0F, 38.2F, 7.2F, 8, 3,
				3, 0.0F, false));
		...
		Body.addChild(Butt);
		Butt.cubeList.add(new ModelBox(Butt, 11, 16, -1.99F, 35.75F, 15.55F, 8,
				6, 3, 0.0F, false));
		...
		Butt.addChild(bone);
		bone.cubeList.add(new ModelBox(bone, 8, 15, -1.99F, 41.8F, -36.9F, 8,
				2, 3, 0.0F, false));
		...
		Chestup.cubeList.add(new ModelBox(Chestup, 6, 15, -1.991F, 22.0089F,
				31.539F, 7, 5, 7, 0.0F, false));
		...
		Chestdown.cubeList.add(new ModelBox(Chestdown, 9, 22, -2.0F, 5.2F,
				42.1321F, 8, 6, 4, 0.0F, false));
		...
		TailBase.cubeList.add(new ModelBox(TailBase, 18, 20, 1.01F, 40.6894F,
				-1.8385F, 2, 2, 7, 0.0F, false));
		...
		TailMedium.cubeList.add(new ModelBox(TailMedium, 56, 7, 1.0F, 21.8221F,
				-34.9362F, 2, 8, 2, 0.0F, false));
		...
		TailEnd.cubeList.add(new ModelBox(TailEnd, 1, 28, 1.01F, 8.1859F,
				-26.2545F, 2, 2, 2, 0.0F, false));
		TailEnd.cubeList.add(new ModelBox(TailEnd, 49, 8, 1.01F, 8.1859F,
				-31.2545F, 2, 2, 5, 0.0F, false));

		Neck = new ModelRenderer(this);
		Neck.setRotationPoint(0.0F, -3.0F, -17.0F);
		setRotationAngle(Neck, 1.2292F, 0.0F, 0.0F);
		BodyAll.addChild(Neck);
		Neck.cubeList.add(new ModelBox(Neck, 8, 17, -0.5F, 15.6699F, -32.8845F,
				5, 9, 4, 0.0F, false));
		...
		Neck.addChild(Head);
		Head.cubeList.add(new ModelBox(Head, 2, 0, -3.0F, -3.9553F, -0.1143F,
				6, 6, 5, 0.0F, false));
		...
		Head.addChild(Nose);
		Nose.cubeList.add(new ModelBox(Nose, 49, 7, 0.5F, 21.1941F, -50.9084F,
				3, 4, 2, 0.0F, false));
		...
		Head.addChild(EarL);
		EarL.cubeList.add(new ModelBox(EarL, 42, 7, -12.0085F, 38.9419F,
				-27.0638F, 1, 2, 2, 0.0F, false));

		Mouth = new ModelRenderer(this);
		Mouth.setRotationPoint(-2.0F, -74.6F, 15.0F);
		setRotationAngle(Mouth, 0.2731F, 0.0F, 0.0F);
		Head.addChild(Mouth);
		Mouth.cubeList.add(new ModelBox(Mouth, 4, 8, 0.0F, 63.2792F, -33.9759F,
				4, 5, 3, 0.0F, false));
		...
		Head.addChild(EarR);
		EarR.cubeList.add(new ModelBox(EarR, 45, 6, 14.9567F, 37.8704F,
				-26.903F, 1, 2, 2, 0.0F, false));
		...
		NeckDown.cubeList.add(new ModelBox(NeckDown, 19, 11, 0.01F, 39.4304F,
				-2.3978F, 4, 8, 3, 0.0F, false));

		ArmL = new ModelRenderer(this);
		ArmL.setRotationPoint(1.0F, 36.0F, -8.0F);
		setRotationAngle(ArmL, 0.0456F, 0.0F, 0.0F);
		BodyAll.addChild(ArmL);
		ArmL.cubeList.add(new ModelBox(ArmL, 48, 14, 2.0F, -2.8665F, -1.1397F,
				4, 8, 4, 0.0F, false));
		...
		ForearmL.cubeList.add(new ModelBox(ForearmL, 51, 14, -3.5F, 9.1741F,
				13.49F, 3, 9, 3, 0.0F, false));
		...
		HandL.cubeList.add(new ModelBox(HandL, 48, 0, -3.0F, 4.4F, 10.9F, 4, 2,
				4, 0.0F, false));
		...
		ArmL2.cubeList.add(new ModelBox(ArmL2, 12, 18, -4.0F, -2.8665F,
				-1.1397F, 4, 8, 4, 0.0F, false));
		...
		ForearmL2.cubeList.add(new ModelBox(ForearmL2, 52, 10, -3.5F, 9.1741F,
				13.49F, 3, 9, 3, 0.0F, false));
		...
		HandL2.cubeList.add(new ModelBox(HandL2, 48, 0, -3.0F, 4.3F, 10.9F, 4,
				2, 4, 0.0F, false));
		...
		HipL.cubeList.add(new ModelBox(HipL, 48, 10, 2.7F, -1.9222F, -2.6007F,
				3, 7, 5, 0.0F, false));
		...
		ThoughL.cubeList.add(new ModelBox(ThoughL, 50, 7, -5.0F, -0.8735F,
				-24.0584F, 3, 6, 4, 0.0F, false));

		LegL = new ModelRenderer(this);
		LegL.setRotationPoint(0.0F, 16.0F, 0.0F);
		setRotationAngle(LegL, -0.8652F, 0.0F, 0.0F);
		ThoughL.addChild(LegL);
		LegL.cubeList.add(new ModelBox(LegL, 23, 12, -5.1F, 8.3003F, -24.2498F,
				3, 7, 3, 0.0F, false));

		FeetL = new ModelRenderer(this);
		FeetL.setRotationPoint(-0.6F, 11.0F, 1.0F);
		LegL.addChild(FeetL);
		FeetL.cubeList.add(new ModelBox(FeetL, 46, 0, -5.0F, 3.5F, -26.1998F,
				4, 2, 4, 0.0F, false));
		...
		HipL2.cubeList.add(new ModelBox(HipL2, 47, 11, -3.5F, -2.1083F,
				-2.518F, 3, 7, 5, 0.0F, false));
		...
		ThoughL2.cubeList.add(new ModelBox(ThoughL2, 18, 10, -4.09F, 1.2973F,
				-23.55F, 3, 6, 4, 0.0F, false));
		...
		LegL2.cubeList.add(new ModelBox(LegL2, 47, 11, -4.1F, 9.3F, -22.2497F,
				3, 7, 3, 0.0F, false));

		FeetL2 = new ModelRenderer(this);
		FeetL2.setRotationPoint(-0.6F, 11.0F, 1.0F);
		LegL2.addChild(FeetL2);
		FeetL2.cubeList.add(new ModelBox(FeetL2, 46, 0, -4.0F, 4.5F, -24.1997F,
				4, 2, 4, 0.0F, false));
	}
