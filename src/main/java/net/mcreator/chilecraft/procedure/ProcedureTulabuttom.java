...
public class ProcedureTulabuttom extends ElementsChileanCraftMod.ModElement {
	public ProcedureTulabuttom(ElementsChileanCraftMod instance) {
		super(instance, 485);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Tulabuttom!");
			return;
		}
