...
public class ProcedureEfe extends ElementsChileanCraftMod.ModElement {
	public ProcedureEfe(ElementsChileanCraftMod instance) {
		super(instance, 822);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Efe!");
			return;
		}
