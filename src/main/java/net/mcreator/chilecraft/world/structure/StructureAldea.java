...
public class StructureAldea extends ElementsChileanCraftMod.ModElement {
	public StructureAldea(ElementsChileanCraftMod instance) {
		super(instance, 746);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 1400) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("chilean_craft", "aldea3"));
				if (template == null)
					return;
