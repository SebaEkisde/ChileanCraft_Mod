...
public class BlockSlabsaraucary extends ElementsChileanCraftMod.ModElement {
	@GameRegistry.ObjectHolder("chilean_craft:slabsaraucary")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("chilean_craft:slabsaraucary_double")
	public static final Block block_slab_double = null;
	public BlockSlabsaraucary(ElementsChileanCraftMod instance) {
		super(instance, 32);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("slabsaraucary"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("slabsaraucary_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("chilean_craft:slabsaraucary", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("slabsaraucary");
