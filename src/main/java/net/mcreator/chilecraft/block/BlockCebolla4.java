...
public class BlockCebolla4 extends ElementsChileanCraftMod.ModElement {
	@GameRegistry.ObjectHolder("chilean_craft:cebolla4")
	public static final Block block = null;
	public BlockCebolla4(ElementsChileanCraftMod instance) {
		super(instance, 310);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("chilean_craft:cebolla4", "inventory"));
	}
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0.5F);
			setLightLevel(0F);
			setUnlocalizedName("cebolla4");
			setRegistryName("cebolla4");
		}
