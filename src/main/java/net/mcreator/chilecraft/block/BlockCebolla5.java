...
public class BlockCebolla5 extends ElementsChileanCraftMod.ModElement {
	@GameRegistry.ObjectHolder("chilean_craft:cebolla5")
	public static final Block block = null;
	public BlockCebolla5(ElementsChileanCraftMod instance) {
		super(instance, 311);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("chilean_craft:cebolla5", "inventory"));
	}
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0.5F);
			setLightLevel(0F);
			setUnlocalizedName("cebolla5");
			setRegistryName("cebolla5");
		}
