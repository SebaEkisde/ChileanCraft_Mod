...
import net.mcreator.chilecraft.procedure.ProcedureCardoMobplayerCollidesWithPlant;
...
public class BlockCardo extends ElementsChileanCraftMod.ModElement {
	@GameRegistry.ObjectHolder("chilean_craft:cardo")
	public static final Block block = null;
	public BlockCardo(ElementsChileanCraftMod instance) {
		super(instance, 66);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("chilean_craft:cardo", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("cardo");
			setRegistryName("cardo");
		}
		...
		public void onEntityCollidedWithBlock(World world, BlockPos pos, IBlockState state, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureCardoMobplayerCollidesWithPlant.executeProcedure($_dependencies);
			}
		}
	}
}
