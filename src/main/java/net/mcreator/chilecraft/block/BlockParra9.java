...
import net.mcreator.chilecraft.procedure.ProcedureParra9PlantRightClicked;
...
public class BlockParra9 extends ElementsChileanCraftMod.ModElement {
	@GameRegistry.ObjectHolder("chilean_craft:parra9")
	public static final Block block = null;
	public BlockParra9(ElementsChileanCraftMod instance) {
		super(instance, 334);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("chilean_craft:parra9", "inventory"));
	}
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("parra9");
			setRegistryName("parra9");
		}
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureParra9PlantRightClicked.executeProcedure($_dependencies);
			}
			return retval;
		}
