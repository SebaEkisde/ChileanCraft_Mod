...
public class BlockCopperore extends ElementsChileanCraftMod.ModElement {
	@GameRegistry.ObjectHolder("chilean_craft:copperore")
	public static final Block block = null;
	public BlockCopperore(ElementsChileanCraftMod instance) {
		super(instance, 5);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("chilean_craft:copperore", "inventory"));
	}
