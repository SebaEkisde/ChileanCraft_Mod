...
public class BlockCebolla0 extends ElementsChileanCraftMod.ModElement {
	@GameRegistry.ObjectHolder("chilean_craft:cebolla0")
	public static final Block block = null;
	public BlockCebolla0(ElementsChileanCraftMod instance) {
		super(instance, 306);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("chilean_craft:cebolla0", "inventory"));
	}
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0.5F);
			setLightLevel(0F);
			setUnlocalizedName("cebolla0");
			setRegistryName("cebolla0");
		}
