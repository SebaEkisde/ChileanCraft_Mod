...
public class BlockBailahuen extends ElementsChileanCraftMod.ModElement {
	@GameRegistry.ObjectHolder("chilean_craft:bailahuen")
	public static final Block block = null;
	public BlockBailahuen(ElementsChileanCraftMod instance) {
		super(instance, 62);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("chilean_craft:bailahuen", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0.5F);
			setLightLevel(0F);
			setUnlocalizedName("bailahuen");
			setRegistryName("bailahuen");
		}
