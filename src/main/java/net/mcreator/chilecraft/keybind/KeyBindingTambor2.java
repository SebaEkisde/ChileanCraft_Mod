...
import net.mcreator.chilecraft.procedure.ProcedureTambor2OnKeyPressed;
...
public class KeyBindingTambor2 extends ElementsChileanCraftMod.ModElement {
	private KeyBinding keys;
	public KeyBindingTambor2(ElementsChileanCraftMod instance) {
		super(instance, 775);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.tambor_2", Keyboard.KEY_H, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureTambor2OnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
