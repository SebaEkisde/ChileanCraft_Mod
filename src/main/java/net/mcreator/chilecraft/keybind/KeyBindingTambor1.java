...
package net.mcreator.chilecraft.keybind;
...
import net.mcreator.chilecraft.procedure.ProcedureTambor1OnKeyPressed;
...
public class KeyBindingTambor1 extends ElementsChileanCraftMod.ModElement {
	private KeyBinding keys;
	public KeyBindingTambor1(ElementsChileanCraftMod instance) {
		super(instance, 774);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.tambor_1", Keyboard.KEY_G, "key.categories.misc");
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		if (Minecraft.getMinecraft().currentScreen == null) {
			if (org.lwjgl.input.Keyboard.isKeyDown(keys.getKeyCode())) {
				ChileanCraftMod.PACKET_HANDLER.sendToServer(new KeyBindingPressedMessage());
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureTambor1OnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
