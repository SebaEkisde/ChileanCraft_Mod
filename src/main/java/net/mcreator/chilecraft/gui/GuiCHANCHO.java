...
public class GuiCHANCHO extends ElementsChileanCraftMod.ModElement {
	public static int GUIID = 4;
	public static HashMap guistate = new HashMap();
	public GuiCHANCHO(ElementsChileanCraftMod instance) {
		super(instance, 266);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 107, 29) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("chilean_craft:textures/chancho.png");
		@Override
