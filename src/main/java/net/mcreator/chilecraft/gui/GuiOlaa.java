...
public class GuiOlaa extends ElementsChileanCraftMod.ModElement {
	public static int GUIID = 6;
	public static HashMap guistate = new HashMap();
	public GuiOlaa(ElementsChileanCraftMod instance) {
		super(instance, 445);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 144, 37) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 27, 37) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 45, 37) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("chilean_craft:textures/olaa.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("chilean_craft:textures/z.png"));
			this.drawTexturedModalRect(this.guiLeft + 76, this.guiTop + 21, 0, 0, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Olla ", 6, 4, -1);
		}
