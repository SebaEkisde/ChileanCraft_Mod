...
public class GuiParrillagui extends ElementsChileanCraftMod.ModElement {
	public static int GUIID = 13;
	public static HashMap guistate = new HashMap();
	public GuiParrillagui(ElementsChileanCraftMod instance) {
		super(instance, 555);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 63, 22) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 81, 22) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 99, 22) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("chilean_craft:textures/parrillagui.png");
		@Override
