...
import net.mcreator.chilecraft.procedure.ProcedureMoteConHuesilloButtonClickOnIt;
import net.mcreator.chilecraft.procedure.ProcedureFirstGuiAldeanoMotemeiReturnButton;
...
public class GuiVillagerAldeanoMotemeiTraderGui2 extends ElementsChileanCraftMod.ModElement {
	public static int GUIID = 8;
	public static HashMap guistate = new HashMap();
	public GuiVillagerAldeanoMotemeiTraderGui2(ElementsChileanCraftMod instance) {
		super(instance, 519);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("chilean_craft:textures/villageraldeanomotemeitradergui2.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("1x500 pesos", 58, 28, -1);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(1, this.guiLeft + 3, this.guiTop + 6, 170, 20, "Mote Con Huesillo"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureFirstGuiAldeanoMotemeiReturnButton.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				ProcedureMoteConHuesilloButtonClickOnIt.executeProcedure($_dependencies);
			}
		}
	}
