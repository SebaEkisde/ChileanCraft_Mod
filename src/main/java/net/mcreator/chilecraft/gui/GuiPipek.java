...
public class GuiPipek extends ElementsChileanCraftMod.ModElement {
	public static int GUIID = 5;
	public static HashMap guistate = new HashMap();
	public GuiPipek(ElementsChileanCraftMod instance) {
		super(instance, 417);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 50, 39) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 76, 38) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 103, 37) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("chilean_craft:textures/pipek.png");
		@Override
