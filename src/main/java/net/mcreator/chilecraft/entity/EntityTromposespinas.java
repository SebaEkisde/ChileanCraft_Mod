...
public class EntityTromposespinas extends ElementsChileanCraftMod.ModElement {
	public static final int ENTITYID = 104;
	public static final int ENTITYID_RANGED = 105;
	public EntityTromposespinas(ElementsChileanCraftMod instance) {
		super(instance, 753);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("chilean_craft", "tromposespinas"), ENTITYID).name("tromposespinas").tracker(73, 3, true).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modeltrompoespsinas(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("chilean_craft:textures/whatsapp_image_2020-09-10_at_16.24.59.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityMob {
		...
		protected void initEntityAI() {
			...
			this.targetTasks.addTask(9, new EntityAINearestAttackableTarget(this, EntityTrompo3.EntityCustom.class, true, false));
			this.tasks.addTask(10, new EntityAIAttackMelee(this, 1.2, false));
			this.targetTasks.addTask(11, new EntityAINearestAttackableTarget(this, EntityTromo4.EntityCustom.class, true, false));
			this.targetTasks.addTask(12, new EntityAINearestAttackableTarget(this, EntityTrompofuego.EntityCustom.class, true, false));
			this.targetTasks.addTask(13, new EntityAINearestAttackableTarget(this, EntityTrompo5.EntityCustom.class, true, false));
			this.targetTasks.addTask(14, new EntityAINearestAttackableTarget(this, EntityTromposespinas.EntityCustom.class, true, false));
