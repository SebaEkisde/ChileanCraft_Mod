...
import net.mcreator.chilecraft.procedure.ProcedureAldeanoMotemeiRightClickedOnEntity;
import net.mcreator.chilecraft.procedure.ProcedureAldeanoMotemeiItIsStruckByLightning;
...
public class EntityAldeanoMotemei extends ElementsChileanCraftMod.ModElement {
	public static final int ENTITYID = 30;
	public static final int ENTITYID_RANGED = 31;
	public EntityAldeanoMotemei(ElementsChileanCraftMod instance) {
		super(instance, 222);
	}
	...
	public void initElements() {
		elements.entities.add(
				() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("chilean_craft", "aldeanomotemei"), ENTITYID)
						.name("aldeanomotemei").tracker(64, 3, true).egg(-12111848, -4883609).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("mutated_extreme_hills")),
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderLiving customRender = new RenderLiving(renderManager, new ModelVillager(0.0F), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("chilean_craft:textures/motefinal.png");
				}
			};
	...
	public static class EntityCustom extends EntityCreature {
		...
		public void onStruckByLightning(EntityLightningBolt entityLightningBolt) {
			...
			Entity entity = this;
			{
				...
				ProcedureAldeanoMotemeiItIsStruckByLightning.executeProcedure($_dependencies);
			}
		}
		...
		public boolean processInteract(EntityPlayer entity, EnumHand hand) {
			...
			ItemStack itemstack = entity.getHeldItem(hand);
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureAldeanoMotemeiRightClickedOnEntity.executeProcedure($_dependencies);
			}
			return true;
		}
