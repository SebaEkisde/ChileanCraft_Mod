...
import net.mcreator.chilecraft.procedure.ProcedureMatapacosOnEntityTickUpdate;
...
public class EntityMatapacos extends ElementsChileanCraftMod.ModElement {
	public static final int ENTITYID = 3;
	public static final int ENTITYID_RANGED = 4;
	public EntityMatapacos(ElementsChileanCraftMod instance) {
		super(instance, 396);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("chilean_craft", "matapacos"), ENTITYID).name("matapacos").tracker(64, 3, true).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modelmatapaco(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("chilean_craft:textures/matapacosww.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityCreature {
		...
		protected void initEntityAI() {
			...
			this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityMob.class, true, true));
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				...
				ProcedureMatapacosOnEntityTickUpdate.executeProcedure($_dependencies);
			}
		}
