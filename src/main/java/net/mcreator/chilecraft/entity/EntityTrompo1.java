...
public class EntityTrompo1 extends ElementsChileanCraftMod.ModElement {
	public static final int ENTITYID = 85;
	public static final int ENTITYID_RANGED = 86;
	public EntityTrompo1(ElementsChileanCraftMod instance) {
		super(instance, 712);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("chilean_craft", "trompo_1"), ENTITYID).name("trompo_1").tracker(73, 3, true).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modeltrompo(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("chilean_craft:textures/trompox1.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityMob {
		...
		protected void initEntityAI() {
			...
			this.tasks.addTask(15, new EntityAIAttackMelee(this, 1.2, false));
