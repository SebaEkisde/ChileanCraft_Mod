...
public class EntityTrompo2 extends ElementsChileanCraftMod.ModElement {
	public static final int ENTITYID = 88;
	public static final int ENTITYID_RANGED = 89;
	public EntityTrompo2(ElementsChileanCraftMod instance) {
		super(instance, 714);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("chilean_craft", "trompo_2"), ENTITYID).name("trompo_2").tracker(73, 3, true).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modeltrompo(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("chilean_craft:textures/trompox2.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityMob {
		...
		protected void initEntityAI() {
			...
			this.targetTasks.addTask(10, new EntityAINearestAttackableTarget(this, EntityTrompo3.EntityCustom.class, true, false));
			this.targetTasks.addTask(11, new EntityAINearestAttackableTarget(this, EntityTromo4.EntityCustom.class, true, false));
			this.targetTasks.addTask(12, new EntityAINearestAttackableTarget(this, EntityTrompo5.EntityCustom.class, true, false));
			this.tasks.addTask(13, new EntityAIBreakDoor(this));
			this.targetTasks.addTask(14, new EntityAINearestAttackableTarget(this, EntityTrompofuego.EntityCustom.class, true, false));
			this.targetTasks.addTask(15, new EntityAINearestAttackableTarget(this, EntityTromposespinas.EntityCustom.class, true, false));
