...
public class EntityDealer extends ElementsChileanCraftMod.ModElement {
	...
	public EntityDealer(ElementsChileanCraftMod instance) {
		super(instance, 235);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("chilean_craft", "aldeanodealer"), ENTITYID)
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderLiving customRender = new RenderLiving(renderManager, new ModelVillager(0.0F), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("chilean_craft:textures/dealerfinl.png");
				}
			};
	...
	public static class EntityCustom extends EntityMob {
		...
		public boolean processInteract(EntityPlayer entity, EnumHand hand) {
			...
			ItemStack itemstack = entity.getHeldItem(hand);
			{
				...
				ProcedureDealerRightClickedOnEntity.executeProcedure($_dependencies);
			}
			return true;
		}
