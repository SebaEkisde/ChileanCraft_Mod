...
public class EntityEspnol extends ElementsChileanCraftMod.ModElement {
	public static final int ENTITYID = 8;
	public static final int ENTITYID_RANGED = 9;
	public EntityEspnol(ElementsChileanCraftMod instance) {
		super(instance, 229);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("chilean_craft", "espnol"), ENTITYID).name("espnol").tracker(64, 3, true).egg(-1, -16777216).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("chilean_craft:araucartforest")),
				...
				Biome.REGISTRY.getObject(new ResourceLocation("forest")), Biome.REGISTRY.getObject(new ResourceLocation("frozen_river")),};
	...
	public static class EntityCustom extends EntityMob {
		...
		protected void initEntityAI() {
			...
			this.targetTasks.addTask(9, new EntityAINearestAttackableTarget(this, EntityPlayerMP.class, true, true));
			this.targetTasks.addTask(10, new EntityAINearestAttackableTarget(this, EntityMapuche.EntityCustom.class, true, true));
		}
