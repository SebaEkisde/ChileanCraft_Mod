...
import net.mcreator.chilecraft.procedure.ProcedureCreepinochetEntityDies;
...
public class EntityCreepinochet extends ElementsChileanCraftMod.ModElement {
	public static final int ENTITYID = 28;
	public static final int ENTITYID_RANGED = 29;
	public EntityCreepinochet(ElementsChileanCraftMod instance) {
		super(instance, 221);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("chilean_craft", "creepinochet"), ENTITYID)
						.name("creepinochet").tracker(64, 3, true).egg(-10027264, -52480).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelCreeper(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("chilean_craft:textures/ibujo_11.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityCreeper {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemPiochet.helmet, (int) (1)).getItem();
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				ProcedureCreepinochetEntityDies.executeProcedure($_dependencies);
			}
		}
