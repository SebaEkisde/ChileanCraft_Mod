...
import net.mcreator.chilecraft.item.ItemPistoala;
import net.mcreator.chilecraft.item.ItemPerdogon;
import net.mcreator.chilecraft.item.ItemCascoespanol;
import net.mcreator.chilecraft.ElementsChileanCraftMod;

@ElementsChileanCraftMod.ModElement.Tag
public class EntityEspanol2 extends ElementsChileanCraftMod.ModElement {
	public static final int ENTITYID = 11;
	public static final int ENTITYID_RANGED = 12;
	public EntityEspanol2(ElementsChileanCraftMod instance) {
		super(instance, 230);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("chilean_craft", "espanol2"), ENTITYID).name("espanol2").tracker(100, 3, true).egg(-1, -16777216).build());
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("chilean_craft", "entitybulletespanol2"), ENTITYID_RANGED).name("entitybulletespanol2").tracker(64, 1, true)
				.build());
	}
	...
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("forest")), Biome.REGISTRY.getObject(new ResourceLocation("taiga")),
				...
				Biome.REGISTRY.getObject(new ResourceLocation("chilean_craft:araucartforest")),};
		EntityRegistry.addSpawn(EntityCustom.class, 1, 1, 2, EnumCreatureType.MONSTER, spawnBiomes);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("chilean_craft:textures/conquistador.png");
				}
			};
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityArrowCustom.class, renderManager -> {
			return new RenderSnowball<EntityArrowCustom>(renderManager, null, Minecraft.getMinecraft().getRenderItem()) {
				public ItemStack getStackToRender(EntityArrowCustom entity) {
					return new ItemStack(ItemPerdogon.block, (int) (1));
				}
			};
		});
	}
	public static class EntityCustom extends EntityMob implements IRangedAttackMob {
		public EntityCustom(World world) {
			...
			setNoAI(!true);
			this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(ItemPistoala.block, (int) (1)));
		...
		protected void initEntityAI() {
			...
			this.targetTasks.addTask(4, new EntityAINearestAttackableTarget(this, EntityMapuche.EntityCustom.class, true, false));
