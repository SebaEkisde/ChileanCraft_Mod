...
public class EntityTrompo3 extends ElementsChileanCraftMod.ModElement {
	public static final int ENTITYID = 95;
	public static final int ENTITYID_RANGED = 96;
	public EntityTrompo3(ElementsChileanCraftMod instance) {
		super(instance, 716);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("chilean_craft", "trompo_3"), ENTITYID).name("trompo_3").tracker(73, 3, true).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modeltrompo(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("chilean_craft:textures/trompox3.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityMob {
		...
		protected void initEntityAI() {
			...
			this.targetTasks.addTask(5, new EntityAINearestAttackableTarget(this, EntityTromp.EntityCustom.class, false, false));
			this.targetTasks.addTask(6, new EntityAINearestAttackableTarget(this, EntityTrompo5.EntityCustom.class, false, false));
			this.targetTasks.addTask(7, new EntityAINearestAttackableTarget(this, EntityTrompo3.EntityCustom.class, false, false));
			this.targetTasks.addTask(8, new EntityAINearestAttackableTarget(this, EntityTromo4.EntityCustom.class, false, false));
			this.targetTasks.addTask(9, new EntityAINearestAttackableTarget(this, EntityTrompo2.EntityCustom.class, false, false));
			this.targetTasks.addTask(10, new EntityAINearestAttackableTarget(this, EntityTrompo1.EntityCustom.class, false, false));
			this.targetTasks.addTask(11, new EntityAINearestAttackableTarget(this, EntityTrompofuego.EntityCustom.class, false, false));
			this.targetTasks.addTask(12, new EntityAINearestAttackableTarget(this, EntityTromposespinas.EntityCustom.class, false, false));
			this.tasks.addTask(13, new EntityAIBreakDoor(this));
			this.tasks.addTask(14, new EntityAIAttackMelee(this, 1.2, true));
			this.tasks.addTask(16, new EntityAIWander(this, 1));
			this.targetTasks.addTask(17, new EntityAIHurtByTarget(this, true));
			this.tasks.addTask(18, new EntityAILookIdle(this));
			this.tasks.addTask(19, new EntityAISwimming(this));
		}
