...
import net.mcreator.chilecraft.procedure.ProcedureTrompofuegoPlayerCollidesWithThisEntity;
import net.mcreator.chilecraft.procedure.ProcedureTrompofuegoEntityIsHurt;
...
public class EntityTrompofuego extends ElementsChileanCraftMod.ModElement {
	public static final int ENTITYID = 102;
	public static final int ENTITYID_RANGED = 103;
	public EntityTrompofuego(ElementsChileanCraftMod instance) {
		super(instance, 740);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("chilean_craft", "trompofuego"), ENTITYID).name("trompofuego").tracker(73, 3, true).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modeltrompo(), 0.2f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("chilean_craft:textures/trompofeugo.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityMob {
		...
		protected void initEntityAI() {
			...
			this.targetTasks.addTask(5, new EntityAINearestAttackableTarget(this, EntityCabra.EntityCustom.class, true, false));
			...
			this.targetTasks.addTask(10, new EntityAINearestAttackableTarget(this, EntityTrompofuego.EntityCustom.class, true, false));
			this.targetTasks.addTask(11, new EntityAINearestAttackableTarget(this, EntityTromposespinas.EntityCustom.class, true, false));
			this.tasks.addTask(12, new EntityAIBreakDoor(this));
			this.targetTasks.addTask(13, new EntityAINearestAttackableTarget(this, EntityTrompo3.EntityCustom.class, true, false));
			this.targetTasks.addTask(14, new EntityAINearestAttackableTarget(this, EntityTromo4.EntityCustom.class, true, false));
			this.targetTasks.addTask(15, new EntityAINearestAttackableTarget(this, EntityTrompo5.EntityCustom.class, true, false));
			this.tasks.addTask(16, new EntityAIAttackMelee(this, 1.2, false));
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureTrompofuegoEntityIsHurt.executeProcedure($_dependencies);
			}
		...
		public void onCollideWithPlayer(EntityPlayer entity) {
			...
			int z = (int) this.posZ;
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				ProcedureTrompofuegoPlayerCollidesWithThisEntity.executeProcedure($_dependencies);
			}
		}
