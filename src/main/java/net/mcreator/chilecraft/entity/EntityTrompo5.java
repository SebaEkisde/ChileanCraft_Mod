...
public class EntityTrompo5 extends ElementsChileanCraftMod.ModElement {
	public static final int ENTITYID = 99;
	public static final int ENTITYID_RANGED = 100;
	public EntityTrompo5(ElementsChileanCraftMod instance) {
		super(instance, 718);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("chilean_craft", "trompo_5"), ENTITYID).name("trompo_5").tracker(73, 3, true).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modeltrompo(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("chilean_craft:textures/trompox5.png");
				}
			};
		});
	}
