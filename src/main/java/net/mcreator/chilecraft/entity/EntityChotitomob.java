...
public class EntityChotitomob extends ElementsChileanCraftMod.ModElement {
	public static final int ENTITYID = 64;
	public static final int ENTITYID_RANGED = 65;
	public EntityChotitomob(ElementsChileanCraftMod instance) {
		super(instance, 241);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("chilean_craft", "chotitomob"), ENTITYID)
						.name("chotitomob").tracker(64, 3, true).egg(-16777216, -13421773).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		EntityRegistry.addSpawn(EntityCustom.class, 1000, 8, 8, EnumCreatureType.CREATURE, spawnBiomes);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modelchoito(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("chilean_craft:textures/chr.png");
				}
			};
		});
	}
