...
public class EntityTromp extends ElementsChileanCraftMod.ModElement {
	public static final int ENTITYID = 77;
	public static final int ENTITYID_RANGED = 78;
	public EntityTromp(ElementsChileanCraftMod instance) {
		super(instance, 704);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("chilean_craft", "tromp"), ENTITYID).name("tromp").tracker(73, 3, true).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modeltrompo(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("chilean_craft:textures/trompox.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityMob {
		...
		protected void initEntityAI() {
			...
			this.targetTasks.addTask(6, new EntityAINearestAttackableTarget(this, EntityTrompo1.EntityCustom.class, false, false));
			this.targetTasks.addTask(7, new EntityAINearestAttackableTarget(this, EntityTrompo2.EntityCustom.class, false, false));
			this.targetTasks.addTask(8, new EntityAINearestAttackableTarget(this, EntityTrompo3.EntityCustom.class, false, false));
			this.targetTasks.addTask(9, new EntityAINearestAttackableTarget(this, EntityTromo4.EntityCustom.class, false, false));
			this.targetTasks.addTask(10, new EntityAINearestAttackableTarget(this, EntityTrompo5.EntityCustom.class, false, false));
			this.targetTasks.addTask(11, new EntityAINearestAttackableTarget(this, EntityTromposespinas.EntityCustom.class, false, false));
			this.targetTasks.addTask(12, new EntityAINearestAttackableTarget(this, EntityTrompofuego.EntityCustom.class, false, false));
